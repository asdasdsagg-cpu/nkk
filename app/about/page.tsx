...
export const metadata: Metadata = {
  title: "О проекте — Топливо рядом",
  description: "«Топливо рядом» — бесплатный сервис, который показывает, где сейчас есть топливо на АЗС.",
};
      ...
      <div className="legal-page">
        <div className="legal-inner">
          ...
          <p className="legal-lead">
            «Топливо рядом» — бесплатный сервис, который показывает, где сейчас есть топливо на АЗС: наличие бензина и дизеля, очереди и свежесть данных. Цель — помочь водителям не тратить время на поиск заправки вслепую.
          </p>
          ...
          <section>
            <h2>Откуда данные</h2>
            <p>
              Основу составляют анонимные отметки пользователей и доступная открытая информация. «Топливо рядом» не является заправочной сетью, не продаёт топливо и не располагает официальными данными АЗС.
            </p>
            <p>
